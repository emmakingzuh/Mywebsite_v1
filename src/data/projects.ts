...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: 'A 2D animated short featuring pirate ships and houses, shared as a YouTube Short.',
    longDescription: 'A 2D animation experiment featuring stylized pirate ships and houses. The piece showcases 3D scene-building, lighting, and camera work in a short-form vertical format. The animation demonstrates the ability to create immersive 2D worlds even within the constraints of social-first content.',
    role: '2D Animator, Generalist',
    client: 'Personal',
    year: '2024',
  ...
  },
  {
    ...
    description: 'A compact 3D character animation study — expressive motion and personality distilled into a square-format micro-piece that showcases rigging and animation craft.',
  ...
  },
  {
    ...
    description: 'A playful 3D character animation inspired by the Humpty Dumpty nursery rhyme — bouncy motion and warm tones bringing a classic character to life in a square micro-format.',
